  ...
  const processes = [
    {
      step: "01",
      icon: Search,
      title: language === "en" ? "Keyword Research" : "Riset Kata Kunci",
      description:
        language === "en"
    ...
    },
    {
      step: "02",
      icon: FileText,
      title: language === "en" ? "Content Planning" : "Perencanaan Konten",
      description:
        language === "en"
    ...
    },
    {
      step: "03",
      icon: Target,
      title: language === "en" ? "SEO Writing" : "Penulisan SEO",
      description:
        language === "en"
    ...
    },
    {
      step: "04",
      icon: TrendingUp,
      title: language === "en" ? "Optimization" : "Optimisasi",
      description:
        language === "en"
    ...
    },
    {
      step: "05",
      icon: CheckCircle,
      title: language === "en" ? "Quality Review" : "Review Kualitas",
      description:
        language === "en"
    ...
    },
    {
      step: "06",
      icon: BarChart,
      title: language === "en" ? "Performance Tracking" : "Pelacakan Performa",
      description:
        language === "en"
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          <h2 className="text-3xl md:text-4xl font-bold text-foreground mb-4">
            {language === "en" ? "Our SEO Article Process" : "Proses Artikel SEO Kami"}
          </h2>
        ...
        <div className="mt-16 text-center">
          <div className="bg-primary/5 rounded-2xl p-8 max-w-4xl mx-auto">
            <h3 className="text-2xl font-bold text-foreground mb-4">
              {language === "en" ? "Quality Guarantee" : "Jaminan Kualitas"}
            </h3>
