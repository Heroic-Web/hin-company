...
export function DesignServices() {
  ...
  const services = [
    {
      icon: Palette,
      title: language === "en" ? "Brand Identity" : "Identitas Brand",
      description:
        language === "en"
    ...
    {
      icon: Smartphone,
      title: language === "en" ? "Mobile App Design" : "Desain Aplikasi Mobile",
      description:
        language === "en"
    ...
    {
      icon: Package,
      title: language === "en" ? "Packaging Design" : "Desain Kemasan",
      description:
        language === "en"
    ...
    {
      icon: Zap,
      title: language === "en" ? "Motion Graphics" : "Motion Graphics",
      description:
        language === "en"
      ...
      <div className="container mx-auto px-4">
        <div className="text-center mb-16">
          <h2 className="text-3xl lg:text-4xl font-bold text-gray-900 dark:text-white mb-4">
            {language === "en" ? "Our Design Services" : "Layanan Desain Kami"}
          </h2>
