      ...
      <div className="container mx-auto px-4 relative">
        <div className="max-w-4xl mx-auto text-center">
          <div className="inline-flex items-center gap-2 bg-emerald-100 dark:bg-emerald-900/30 text-emerald-700 dark:text-emerald-300 px-4 py-2 rounded-full text-sm font-medium mb-6">
            ...
            {t.language === "en" ? "Professional Design Services" : "Layanan Desain Profesional"}
          </div>

          <h1 className="text-4xl lg:text-6xl font-bold text-gray-900 dark:text-white mb-6 text-balance">
            {t.language === "en" ? (
              <>
                Creative Design Solutions for Your <span className="text-emerald-600">Brand</span>
              </>
            ) : (
              <>
                Solusi Desain Kreatif untuk <span className="text-emerald-600">Brand</span> Anda
              </>
            )}
          </h1>
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Button size="lg" className="bg-emerald-600 hover:bg-emerald-700 text-white">
              ...
              {t.language === "en" ? "View Portfolio" : "Lihat Portfolio"}
            </Button>
            <Button size="lg" variant="outline">
              {t.language === "en" ? "Get Quote" : "Dapatkan Penawaran"}
            </Button>
          </div>
        </div>
      </div>
