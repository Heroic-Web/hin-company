      ...
      <div className="container mx-auto px-4 relative">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            >
              <a
                href="mailto:cs.hinaitech@gmail.com?subject=Permintaan Penawaran&body=Halo,%0ASaya ingin menanyakan mengenai layanan Anda.%0ATolong informasikan lebih lanjut mengenai harga, paket, dan proses kerja.%0ATerima kasih."
              >
